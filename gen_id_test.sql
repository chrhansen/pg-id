...
-- #################################################
-- Test helper to extract timestamp from ID: user_5xZSA9yfP6E1b => 1672920637420
-- (ms since epoch). Edited from https://stackoverflow.com/a/66425745/1213651
    ...
    BEGIN
        ...
        FOR i IN 1..length(encoded_id) LOOP
